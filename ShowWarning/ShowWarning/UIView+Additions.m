...
- (void)addConstraintsWithFormat:(NSString *) format forViews: (NSArray *)views andKeys:(NSArray *)keys{
    
    for (UIView *view in views) {
        view.translatesAutoresizingMaskIntoConstraints = NO;
    }
    
    NSDictionary *viewDictionary = [[NSDictionary alloc] initWithObjects:views forKeys:keys];
